...
extern int BpGetExtNtrPinMux ( void );
...
#if 1
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_LE89156x2 =
{
   VOICECFG_LE89156x2_STR,   /* daughter card ID */
   2,   /* FXS number is 2 */
   0,   /* FXO number is 1 */
   {   /* voiceDevice0 parameters */
      {
      ...
      },
      {
         ...
         BP_VD_ZARLINK_89156,
         BP_SPI_SS_B2,  /* Device uses SPI_SS_B2 pin. Pin on base board depends on base board parameters. */
         BP_RESET_NOT_REQUIRED, /* Device uses FXS2 reset pin. Pin on base board depends on base board parameters. */
         {
            /* Channel 0 on device */
            {
               BP_VOICE_CHANNEL_ACTIVE,
...
// include ZL88601 and DSPG DECT module.
//20140212, TimLiu, App team request to change timeslot for VMG8948
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_VMG8948 =
{
   VOICECFG_ZL88601_STR,   /* szBoardId */
   2,   /* Number of FXS Lines */
   0,   /* Number of FXO Lines */
   {
      /* voiceDevice0 parameters */
      {
         ...
         BP_VD_ZARLINK_88601,
         BP_SPI_SS_B1,  /* Device uses SPI_SS_B1 pin. Pin on base board depends on base board parameters. */
         BP_RESET_NOT_REQUIRED, /* not required */
...
//20140612, TimLiu add for support voice card
#if defined(ZYXEL) && (ZYXEL == 1)
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_VMG89xx_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_VMG8948,
   0
};
//20140903, TimLiu add for support voice card.
// VMG8924`s FXS using the same design with VMG8948 without DECT.
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_VMG8924_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_VMG8948,
   0
};
//20140903, TimLiu add for support voice card.
// VMG3926 is the same as VMG8924 with remove FXS.
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_VMG3926_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   0
};
//20140903, Cj add for support voice card.
// VMG3925 is the same as VMG8924 with remove FXS.
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_VMG3925_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   0
};
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_VMG98xx_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_VMG8948,
   &g_voiceBoard_SI32260,
   0
};
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_VMG8924_B10A_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_LE89156x2,
   0
};
static VOICE_DAUGHTER_BOARD_PARMS * g_963167_VMG8924_B10D_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_LE9642_ZSI_BB,
   0
};
...
static bp_elem_t g_voice_bcm963167ref1[] = {
...
//20140612, TimLiu add for support voice card.
#if defined(ZYXEL) && (ZYXEL == 1)
static bp_elem_t g_voice_bcm963168_VMG8948[] = {
   ...
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_daughterCardList,        .u.ptr = g_963168_VMG89xx_dCardList},
   {bp_last}
};
//20140903, TimLiu add for support voice card.
static bp_elem_t g_voice_bcm963168_VMG8924[] = {
   {bp_cpBoardId,               .u.cp = "963168_VMG8924"},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_HS_SPI},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_PCM},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_daughterCardList,        .u.ptr = g_963168_VMG8924_dCardList},
   {bp_last}
};
//20140903, TimLiu add for support voice card.
static bp_elem_t g_voice_bcm963168_VMG3926[] = {
   {bp_cpBoardId,               .u.cp = "963168_VMG3926"},
   {bp_daughterCardList,        .u.ptr = g_963168_VMG3926_dCardList},
   {bp_last}
};
//20140903, Cj add for support voice card.
static bp_elem_t g_voice_bcm963168_VMG3925[] = {
   {bp_cpBoardId,               .u.cp = "963168_VMG3925"},
   {bp_daughterCardList,        .u.ptr = g_963168_VMG3925_dCardList},
   {bp_last}
};
static bp_elem_t g_voice_bcm963168_VMG9823[] = {
   {bp_cpBoardId,               .u.cp = "963168_VMG9823"},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_HS_SPI},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_PCM},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_35_AL},
   {bp_daughterCardList,        .u.ptr = g_963168_VMG98xx_dCardList},
   {bp_last}
};
static bp_elem_t g_voice_bcm963168_VMG8924_B10A[] = {
   ...
   {bp_daughterCardList,        .u.ptr = g_963168_VMG8924_B10A_dCardList},
   {bp_last}
};
static bp_elem_t g_voice_bcm963167_VMG8924_B10D[] = {
   {bp_cpBoardId,               .u.cp = "VMG8924-B10D"},
   {bp_daughterCardList,        .u.ptr = g_963167_VMG8924_B10D_dCardList},
   {bp_last}
};
static bp_elem_t g_voice_bcm963167_VMG8924_B30D[] = {
...
static bp_elem_t * g_VoiceBoardParms[]=
{
   ...
   g_voice_bcm963167ref1,
//20140612, TimLiu add for support voice card.
#if defined(ZYXEL) && (ZYXEL == 1)
   g_voice_bcm963168_VMG8948,
   g_voice_bcm963168_VMG8924,
   g_voice_bcm963168_VMG3926,
   g_voice_bcm963168_VMG3925,
   g_voice_bcm963168_VMG9823,
   g_voice_bcm963168_VMG8924_B10A,
   g_voice_bcm963167_VMG8924_B10D,
   g_voice_bcm963167_VMG8924_B30D,
#endif
   0
};
...
static bp_elem_t g_voice_bcm968385sfu[] = {                 
   ...
   {bp_usVoipApmChSwap,         .u.us = BP_APMCH_SWAP_OFF},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_bcm968380fhgu},
   {bp_last}                                                    
};                                                              
...
#if defined(ZYXEL) && (ZYXEL==1)
static VOICE_DAUGHTER_BOARD_PARMS * g_963138_dCardListZyXEL[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_ZL88601,
   &g_voiceBoard_LE9642_ZSI_BB,
   0
...
#if defined(ZYXEL) && (ZYXEL==1)
static bp_elem_t g_voice_fmg3586[] = {
   {bp_cpBoardId,               .u.cp = "963138_FMG3586"},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_HS_SPI},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_PCM},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_4_AL},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

static bp_elem_t g_voice_fmg3086[] = {
   {bp_cpBoardId,               .u.cp = "963138_FMG3086"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_fmg3586},
   {bp_last}
};

static bp_elem_t g_voice_xmg3512_b10a[] = {
   {bp_cpBoardId,               .u.cp = "XMG3512-B10A"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

static bp_elem_t g_voice_xmg3512_b10a_lan[] = {
   {bp_cpBoardId,               .u.cp = "XMG3512_LAN"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

static bp_elem_t g_voice_xmg3512_b10a_128MB[] = {
   {bp_cpBoardId,               .u.cp = "XMG3512_128MB"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

static bp_elem_t g_voice_xmg3563_b10a[] = {
   {bp_cpBoardId,               .u.cp = "XMG3563-B10A"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

static bp_elem_t g_voice_xmg3563_b10a_lan[] = {
   {bp_cpBoardId,               .u.cp = "XMG3563_LAN"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

static bp_elem_t g_voice_vmg8823_b10b[] = {
   {bp_cpBoardId,               .u.cp = "VMG8823-B10B"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};
static bp_elem_t g_voice_vmg8823_b30b[] = {
   {bp_cpBoardId,               .u.cp = "VMG8823-B30B"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};
static bp_elem_t g_voice_vmg8823_b50b[] = {
   {bp_cpBoardId,               .u.cp = "VMG8823-B50B"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};
static bp_elem_t g_voice_vmg8823_b60b[] = {
   {bp_cpBoardId,               .u.cp = "VMG8823-B60B"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};
static bp_elem_t g_voice_vmg8825_b50b[] = {
   {bp_cpBoardId,               .u.cp = "VMG8825-B50B"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};
static bp_elem_t g_voice_vmg8825_b60b[] = {
...
// F3000K
static bp_elem_t g_voice_vmg8825_b50k[] = {
   {bp_cpBoardId,               .u.cp = "VMG8825-B50K"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_34_AL},//FXS_RESET_B
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};

#if 1 //(V/X)MG3927,(V/X)MG8825 series
static bp_elem_t g_voice_vmg3927_b50a[] = {
   {bp_cpBoardId,               .u.cp = "VMG3927-B50A"},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListZyXEL},
   {bp_last}
};
static bp_elem_t g_voice_vmg3927_b60a[] = {
   {bp_cpBoardId,               .u.cp = "VMG3927-B60A"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_vmg3927_b50a},
   {bp_last}
};
static bp_elem_t g_voice_xmg3927_b50a[] = {
   {bp_cpBoardId,               .u.cp = "XMG3927-B50A"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_vmg3927_b50a},
   {bp_last}
};
static bp_elem_t g_voice_vmg8825_b50a[] = {
   {bp_cpBoardId,               .u.cp = "VMG8825-B50A"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_vmg3927_b50a},
   {bp_last}
};
static bp_elem_t g_voice_vmg8825_b60a[] = {
   {bp_cpBoardId,               .u.cp = "VMG8825-B60A"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_vmg3927_b50a},
   {bp_last}
};
static bp_elem_t g_voice_xmg8825_b50a[] = {
   {bp_cpBoardId,               .u.cp = "XMG8825-B50A"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_vmg3927_b50a},
   {bp_last}
};
#endif //end of //(V/X)MG3927,(V/X)MG8825 series
...
static bp_elem_t * g_VoiceBoardParms[]=
{
   ...
   g_voice_fmg3586,
   g_voice_fmg3086,
   g_voice_xmg3512_b10a,
   g_voice_xmg3512_b10a_lan,
   g_voice_xmg3512_b10a_128MB,
   g_voice_xmg3563_b10a,
   g_voice_xmg3563_b10a_lan,
   g_voice_vmg8823_b10b,
   g_voice_vmg8823_b30b,
   g_voice_vmg8823_b50b,
   g_voice_vmg8823_b60b,
   g_voice_vmg8825_b50b,
   g_voice_vmg8825_b60b,
   g_voice_vmg8825_b50k,
#if 1 //(V/X)MG3927,(V/X)MG8825 series
   g_voice_vmg3927_b50a,
   g_voice_vmg3927_b60a,
   g_voice_xmg3927_b50a,
   g_voice_vmg8825_b50a,
   g_voice_vmg8825_b60a,
   g_voice_xmg8825_b50a,
#endif
#endif
   0
};
...
#if defined(ZYXEL) && (ZYXEL == 1)
static VOICE_DAUGHTER_BOARD_PARMS * g_963381_vmg5313b_dCardList[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_LE9642_ZSI_BB,
   0
};

static bp_elem_t g_voice_bcm963381_vmg5313_b10b[] = {
   {bp_cpBoardId,               .u.cp = "963381_VMG5313B"},
   //{bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_HS_SPI},
   //{bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_PCM},
   {bp_daughterCardList,        .u.ptr = g_963381_vmg5313b_dCardList},
   {bp_last}
};
#endif
...
{
#if defined(ZYXEL) && (ZYXEL == 1)
   g_voice_bcm963381_vmg5313_b10b,
#endif
...
#if !defined(_CFE_)
/**************************************************************************
* Name       : BpGetNTRExternReference
*
* Description: This function returns true(1) or false(0) if the platfrom
*              supports external NTR reference clock signals
*
* Parameters : void
*
* Returns    : >= 0 : Supports external NTR
*              -1   : Does not support external NTR reference
***************************************************************************/
int BpGetNTRExternReference( void )
{
#if defined(_BCM963138_) || defined(CONFIG_BCM963138)
    bp_elem_t * pElem;

    for( pElem = g_pCurrentBp; pElem && (pElem->id != bp_last); pElem++ ) {
        /* Obtain the external NTR reference */
        if( pElem->id == bp_usNtrRefIn ) {
            return BpGetExtNtrPinMux();
        }
    }
    return -1;
#else
