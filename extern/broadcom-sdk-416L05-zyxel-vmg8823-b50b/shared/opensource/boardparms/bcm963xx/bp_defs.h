...
//20130821, TimLiu add for ZyXEL usage.
  ...
  bp_usExtIntrSensorEvent,	//For VMG8823-B10B use proximity sensor
  // Using GPIO to simulate MDIO/MDC for external switch, RTL8367RB-VB on VMG3925, DSL-491GNAU-B1BC.
  bp_usGpioMDIO_SDA,
  bp_usGpioMDC_SCK,
  bp_usExtIntrExtSwitchInit,	// Interrupt from RTL8367RB-VB on VMG3925, DSL-491GNAU-B1BC.
  bp_usGpioWirelessFEM,	// FEM detection
  ...
  bp_usGpio24GDisable,
  bp_usGpio24GReset,
  bp_usGpioBoardDetect0,    //ZYXEL_BOARD_DETECT_BY_GPIO releated
...
#if defined(ZYXEL) && (ZYXEL==1)
extern WLAN_SROM_PATCH_INFO wlanPaInfoExtra[];
#endif
