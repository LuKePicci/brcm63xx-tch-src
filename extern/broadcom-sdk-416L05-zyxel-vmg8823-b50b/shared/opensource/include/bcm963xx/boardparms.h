...
#define BP_DEVICE_OPTION_DISABLE_EPHY0_SPD_LED (1 << 2)
#define BP_DEVICE_OPTION_DISABLE_EPHY1_SPD_LED (1 << 3)
#define BP_DEVICE_OPTION_DISABLE_EPHY2_SPD_LED (1 << 4)
#define BP_DEVICE_OPTION_DISABLE_GPHY0_SPD0_LED (1 << 5)
#define BP_DEVICE_OPTION_DISABLE_GPHY0_SPD1_LED (1 << 6)
#define BP_DEVICE_OPTION_DISABLE_GPHY0_ALL_SPD_LED ( BP_DEVICE_OPTION_DISABLE_GPHY0_SPD0_LED | BP_DEVICE_OPTION_DISABLE_GPHY0_SPD1_LED)
#define BP_DEVICE_OPTION_DISABLE_ALL_ETHERNET_SPD_LED (BP_DEVICE_OPTION_DISABLE_EPHY0_SPD_LED | \
                                                       BP_DEVICE_OPTION_DISABLE_EPHY1_SPD_LED | \
													   BP_DEVICE_OPTION_DISABLE_EPHY2_SPD_LED | \
													   BP_DEVICE_OPTION_DISABLE_GPHY0_SPD0_LED| \
													   BP_DEVICE_OPTION_DISABLE_GPHY0_SPD1_LED)
//>>20140210, Timliu
...
//port ID on crossbar switch
#define BP_CROSSBAR_PORT_AE              0
#define BP_CROSSBAR_PORT_GPHY4           1
#define BP_CROSSBAR_PORT_GPHY3           4
...
#define MAC_IF_HSGMII           (8 << MAC_IFACE_S)
#define MAC_IF_SS_SMII          (9 << MAC_IFACE_S)
#define MAC_IF_TMII             (10 << MAC_IFACE_S)
#define MAC_IF_RGMII_1P8V       (11 << MAC_IFACE_S)
...
#define PORT_FLAG_ADDNL_WAN         (1 << 9)    /* Experimental additional WAN */
...
#define IsPortAddlWan(flags)         (((flags) & PORT_FLAG_ADDNL_WAN) != 0)
...
#define BP_SFP_NOT_DEFINE	-1
#define BP_SFP_DISABLE		0
#define BP_SFP_ENABLE		1
#endif

#if defined(ZYXEL_ZIGBEE_SUPPORT)
#define BP_ZIGBEE_NOT_DEFINE	-1
#define BP_ZIGBEE_DISABLE		0
#define BP_ZIGBEE_ENABLE		1
#endif

#if defined(ZYXEL_BOARD_DETECT_BY_GPIO)
#define ZYXEL_MAX_BOARD_DETECT_GPIO_NUM     5   /* Max number of gpio for board detecting */
#define ZYXEL_MAX_BOARD_DETECT_QUANTITY     32  /* Max quantity of board definitions */
/*!
 * Basic struct of zyBoardDetectTable[].
 *
 *  @param[in] value            Gpio value.
 *  @param[out] szBoardId[]     Board Id.
 */
typedef struct
{
    unsigned char value;
    char szBoardId[BP_BOARD_ID_LEN];
} ZYXEL_BOARD_DETECT_TABLE;
#endif
...
/*ZyXEL Porting , yushiuan , 2015/01/12.E*/
...
///20130821, TimLiu add for ZyXEL boards
#if defined(ZYXEL) && (ZYXEL==1)
...
// using for initiate RTL8367RB-VB on VMG3925, DSL-491GNAU-B1BC.
...
// ZYXEL_SUPPORT_SW_LAN_AGGREGATE_LED related
...
extern ZYXEL_BOARD_DETECT_TABLE zyBoardDetectTable[ZYXEL_MAX_BOARD_DETECT_QUANTITY];
#endif
...
//In bootloader, it define at cfe/board/bcm63xx_ram/src/dev_bcm63xx_flash.c
//In kernel, it define at linux-3.4.11/arch/arm/mach-bcm963xx/board_963xx.c
extern int isEthwanAsWan;	// 1 means config GPHY4 as WAN, 0 means config GPHY4 as LAN
#endif
