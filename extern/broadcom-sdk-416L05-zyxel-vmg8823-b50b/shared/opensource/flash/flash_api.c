...
/* __zyxel__, co-fw support 256MB and 512MB flash
 * ex. VMG8825-B50B_WIND, XMG3927-Bx0A/XMG8825-Bx0A series. */
#if defined(ZYXEL_SUPPORT_BOTH_256_512_FLASH) && (defined(ZYPRJ_VMG8825_B50B) || defined(ZYPRJ_XMG8825_B50A))
int zyFlashDetectedSize;	//extern in flash_api.h
#endif
 ...
 * ex. VMG8825-B50B_WIND, XMG3927-Bx0A/XMG8825-Bx0A series. */
#if defined(ZYXEL_SUPPORT_BOTH_256_512_FLASH) && (defined(ZYPRJ_VMG8825_B50B) || defined(ZYPRJ_XMG8825_B50A))
    zyFlashDetectedSize = flash_get_total_size() / (1024 * 1024); //MB
    printk(" size %luKB", zyFlashDetectedSize * 1024);
#else
