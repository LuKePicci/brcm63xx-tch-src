...
typedef enum {
    ...
    rdpa_cpu_attr_l4_dst_port_to_reason = 16, /* l4_dst_port_to_reason : RWADF : aggregate/10[256] l4_dst_port_to_reason_cfg(rdpa_l4_dst_port_to_reason_cfg_t) : TCP/UDP dst po */
} rdpa_cpu_attr_types;
...
/** Get cpu/l4_dst_port_to_reason attribute entry.
 *
 * Get TCP/UDP dst port to reason mapping.
 * \param[in]   mo_ cpu object handle or mattr transaction handle
 * \param[in]   ai_ Attribute array index
 * \param[out]  l4_dst_port_to_reason_ Attribute value
 * \return 0 or error code < 0
 * The function can be called in task context only.
 */
static inline int rdpa_cpu_l4_dst_port_to_reason_get(bdmf_object_handle mo_, bdmf_index ai_, rdpa_l4_dst_port_to_reason_cfg_t * l4_dst_port_to_reason_)
{
    return bdmf_attrelem_get_as_buf(mo_, rdpa_cpu_attr_l4_dst_port_to_reason, (bdmf_index)ai_, l4_dst_port_to_reason_, sizeof(*l4_dst_port_to_reason_));
}


/** Add cpu/l4_dst_port_to_reason attribute entry.
 *
 * Add TCP/UDP dst port to reason mapping.
 * \param[in]   mo_ cpu object handle or mattr transaction handle
 * \param[in,out]   ai_ Attribute array index
 * \param[in]   l4_dst_port_to_reason_ Attribute value
 * \return 0 or error code < 0
 * The function can be called in task context only.
 */
static inline int rdpa_cpu_l4_dst_port_to_reason_add(bdmf_object_handle mo_, bdmf_index * ai_, const rdpa_l4_dst_port_to_reason_cfg_t * l4_dst_port_to_reason_)
{
    int rc;
    rc = bdmf_attrelem_add_as_buf(mo_, rdpa_cpu_attr_l4_dst_port_to_reason, (bdmf_index *)ai_, l4_dst_port_to_reason_, sizeof(*l4_dst_port_to_reason_));
    return rc;
}


/** Delete cpu/l4_dst_port_to_reason attribute entry.
 *
 * Delete TCP/UDP dst port to reason mapping.
 * \param[in]   mo_ cpu object handle
 * \param[in]   ai_ Attribute array index
 * \return 0 or error code < 0
 * The function can be called in task context only.
 */
static inline int rdpa_cpu_l4_dst_port_to_reason_delete(bdmf_object_handle mo_, bdmf_index ai_)
{
    return bdmf_attrelem_delete(mo_, rdpa_cpu_attr_l4_dst_port_to_reason, (bdmf_index)ai_);
}


/** Find cpu/l4_dst_port_to_reason attribute entry.
 *
 * Find TCP/UDP dst port to reason mapping.
 * \param[in]   mo_ cpu object handle or mattr transaction handle
 * \param[in,out]   ai_ Attribute array index
 * \param[in,out]   l4_dst_port_to_reason_ Attribute value
 * \return 0 or error code < 0
 * The function can be called in task context only.
 */
static inline int rdpa_cpu_l4_dst_port_to_reason_find(bdmf_object_handle mo_, bdmf_index * ai_, rdpa_l4_dst_port_to_reason_cfg_t * l4_dst_port_to_reason_)
{
    int rc;
    rc = bdmf_attrelem_find(mo_, rdpa_cpu_attr_l4_dst_port_to_reason, (bdmf_index *)ai_, l4_dst_port_to_reason_, sizeof(*l4_dst_port_to_reason_));
    return rc;
}
