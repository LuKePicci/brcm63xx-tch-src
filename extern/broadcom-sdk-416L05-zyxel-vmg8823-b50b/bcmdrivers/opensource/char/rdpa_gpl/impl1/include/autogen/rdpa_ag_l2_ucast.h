...
typedef enum {
    rdpa_l2_ucast_attr_nflows = 0, /* nflows : R : number/4 : number of configured L2 flows */
    rdpa_l2_ucast_attr_flow = 1, /* flow : RWADF : aggregate/142[16512] l2_flow_info(rdpa_l2_flow_info_t) : l2_ucast flow entry */
    rdpa_l2_ucast_attr_flow_stat = 2, /* flow_stat : RF : aggregate/8[16512] rdpa_stat(rdpa_stat_t) : l2_ucast flow entry statistics */
