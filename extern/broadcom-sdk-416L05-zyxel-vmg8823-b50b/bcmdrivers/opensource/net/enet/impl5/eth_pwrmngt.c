...
void zyGetChipIdInfo_eee(char *chipIdInfo)
{
...
void extsw_eee_init(void)
{
   ...
   if (pVnetDev0_g->extSwitch->switch_id == 0x53125) {
      ...
      extsw_bus_contention(0,0);
       ...
       zyGetChipIdInfo_eee(chipIdInfo);
       printk("[extsw_eee_init] chipIdInfo:%s\n", chipIdInfo);
       if ( !strncmp(chipIdInfo, CHIPID_63167, strlen(CHIPID_63167))){
           reg_v16 = 0xf;
           extsw_wreg_wrap(PAGE_EEE, 0x08, (uint8 *)&reg_v16, 1);
           printk("PAGE_EEE, offset 0x08 set=>0xf\n");
       }
#endif
