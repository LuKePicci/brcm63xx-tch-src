...
#ifdef ZYXEL_L2_WAN_SAME_MAC
#define MAC_ADDRESS_WAN         0x50000000
#endif
...
#define UPDATE_FEATURE_BITS(x, y, z)    ((x) ? (y |= z) : (y &= ~z))
...
/*!
 *  MRDFEATUREBITS_XXX :
 *  MRD feature bits offset are defined both in linux header
 *  /linux-brcm963xx_xxx/linux-3.4.11/include/linux/zy_feature_bits.h and
 *  /imageutil /build_dir/host/brcm-imageutil-416L05/board.h,
 *  which is used by /bcmdrivers/opensource/include/bcm963xx/board.h
 *  and
 *  /build_dir/host/brcm-imageutil-416L05/board.h
*/

/*!
 *  Feature Bits Feature : Feature bits table for each project.
 *
 *  @param[in] szBoardId            String for searching.
 *  @param[out] feature_bits        Value of zy_feature_bits.
 */
typedef struct
{
    char szBoardId[NVRAM_BOARD_ID_STRING_LEN];
    unsigned int feature_bits;
} ZYPROJECT_FEATUREBITS_TABLE;
/*!
...
#endif // #if defined(ZYXEL_FEATURE_BITS)
